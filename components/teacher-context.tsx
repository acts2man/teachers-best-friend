...
export type TeacherContextType={w:Workspace;classroom:Classroom;students:Student[];assessments:Assessment[];catalog:Standard[];loaded:boolean;busy:boolean;aiReady:boolean;readOnly:boolean;quota:Quota|null;refreshQuota:()=>void;save:(next:Workspace,message?:string)=>Promise<boolean>;reload:()=>Promise<void>;go:(url:string)=>void};
