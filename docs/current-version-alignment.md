...
This implementation follows the current workflow described in the product brief and the creator's conversation. Later ideas are excluded from the primary experience.

| Current requirement | Implemented behavior |
| --- | --- |
...
- California Grade 4 includes the California Department of Education's Math and ELA records, with official wording and source links. Other grades and frameworks can use teacher-entered standards. The original seven Common Core starter standards remain available.
- Seven standards have prepared reteach lessons. Other standards show general instructional approaches and can use teacher resources or an AI-prepared lesson when the service is connected. They never silently receive an unrelated prepared lesson.
- Automatic document reading and lesson adaptation require the hosted AI service to be configured. Manual assignment entry, answer-key review, student-answer review, saved documents, and reports work without it.
- Document recognition and grading remain teacher-reviewed suggestions. One assignment's score is distinct from mastery over time.

Official catalog sources: [California Grade 4 Mathematics](https://www2.cde.ca.gov/cacs/math?dl=0&maxgrade=4&mingrade=4&order=0&perpage=100) and [California Grade 4 English Language Arts](https://www2.cde.ca.gov/cacs/ela?dl=0&maxgrade=4&mingrade=4&order=0&perpage=100).
